export const SESSIONS = [
	{
		...
		date: 'November 6',
		description:
			'In the first session, we will consider design thinking and its understanding as well as different models of design thinking and the design process, and we will better remember this process with various examples. \n We will also discuss problem solving techniques together and understand the concept of user experience and usability.',
		masters: ['Amalivand'],
	},
	{
	...
	},
	{
		...
		date: 'November 6',
		description:
			'Building experience is one of the key points in product management and design. But how does this experience come about? \n The experience is made by creating a unique feeling in the mind. \n In the fourth session, we will learn how to identify users’ behavior and motivate them as well as build stimuli to drive the minds of the target audience together.',
		masters: ['Mashayekh'],
	},
	{
		title: 'Fifth session',
